# Weird -- archive, truth-probe transfer project (closed 2026-08-27)

Surprises from the earlier project. Its record is in
`logs/archive_truth_probes.md`; the code is in git at `73f06af`.
