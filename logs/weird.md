...
Surprises from the manifold-geometry project.
...
- 2026-08-28 — Massive-activation dimensions do not dominate the covariance
  ...
  and dropping them RAISES D (23.0 to 31.7). A large constant offset moves the
...
- 2026-08-28 — At M=160 the two estimator biases cancel exactly at D=15, giving
  D_hat/D = 1 that is two errors offsetting rather than accuracy. A ratio near
